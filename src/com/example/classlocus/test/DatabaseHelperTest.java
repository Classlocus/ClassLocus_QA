...
public class DatabaseHelperTest extends AndroidTestCase {
	...
	public void testInsert() {
		...
		long id = dbHelper.insert(0, "Waldorf Astoria Building", "WAL", latLng, 10, false);
		assert(id > 0);
	}
	...
	public void testSearch() {
		double[] latLng = {10.101010, -20.202020};
		dbHelper.insert(0, "Waldorf Astoria Building", "WAL", latLng, 10, false);
		dbHelper.insert(0, "Brandenburg Center", "BRC", latLng, 10, false);
